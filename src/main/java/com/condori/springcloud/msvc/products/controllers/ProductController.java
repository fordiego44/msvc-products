package com.condori.springcloud.msvc.products.controllers;
...
import com.condori.springcloud.msvc.products.services.ProductService;
...
final private ProductService service;
    ...
    public ResponseEntity<?> details(@PathVariable Long id) throws InterruptedException  {
        ...
        if (id.equals(10L)) {
            // throw new IllegalStateException("Producto no encontrado!"); solo para usarlo con el corto circuito
        }
        
        if (id.equals(7L)) {
            // TimeUnit.SECONDS.sleep(3L); solo para usarlo con el corto circuito
        }
